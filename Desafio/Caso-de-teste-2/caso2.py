...
with open('c2_transfere.txt', 'w') as f:
    f.write(f"{header}\n{linhaSeparadora}\n")
    f.write('\n'.join(estoque))

with open('c2_divergencias.txt', 'w') as f:
    f.write('\n'.join(divergencias))
...
with open('c2_totcanal.txt', 'w') as f:
    f.write(f"{header}\n{linhaSeparadora}\n")
